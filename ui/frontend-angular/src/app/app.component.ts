...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, MatButtonModule, MatDialogModule, MatFormFieldModule, MatInputModule, NgIf, MatProgressSpinnerModule],
  styles: [`
    .register-dialog {
      display: grid;
      gap: 12px;
  ...
  template: `
    ...
    <div mat-dialog-content class="register-dialog">
      ...
      <mat-form-field appearance="outline">
        ...
        <input matInput type="email" [(ngModel)]="form.email" autocomplete="email">
      </mat-form-field>
      <mat-form-field appearance="outline">
        <mat-label>Password</mat-label>
        <input matInput type="password" [(ngModel)]="form.password" autocomplete="new-password">
      </mat-form-field>
      <mat-form-field appearance="outline">
        <mat-label>First name</mat-label>
        <input matInput [(ngModel)]="form.firstName" autocomplete="given-name">
      </mat-form-field>
      <mat-form-field appearance="outline">
        <mat-label>Last name</mat-label>
        <input matInput [(ngModel)]="form.lastName" autocomplete="family-name">
      </mat-form-field>
